...
// export default function Gantt2() {
//   const tasks = [
//     {
//       id: 20,
//       text: "New Task",
...
//   return(<Willow> <Gantt tasks={tasks} links={links} scales={scales} /></Willow>)
// }
...
export default function CustomEditorExample() {
  ...
  // selected task for custom form
  const [task, setTask] = useState<ITask | null>(null);

  // refs for Gantt api and store
  ...
  // handle actions coming from custom form
  function formAction(ev: {
    ...
    switch (action) {
      ...
      case "delete-task":
        apiRef.current?.exec("delete-task", {
          id: data.id!,
        });
        break;
    ...
    <>
      <div className="h-screen w-full flex">
        <div className="flex-1 h-full w-full flex">
          <Willow>
            <div className="h-full w-full flex willow-root">
              <Gantt
                tasks={data.tasks}
                links={data.links}
                scales={data.scales}
